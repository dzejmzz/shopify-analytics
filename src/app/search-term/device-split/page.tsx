...
const sidebarItems = [
  ...
  { name: "Keyword by Device", icon: Squares2X2Icon, href: "/search-term/device-split", active: true },
...
export default function KeywordByDevice() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 flex items-center justify-center">
        <div className="flex items-center gap-3">
          ...
          <span className="text-slate-300 text-lg">Loading keyword by device analysis...</span>
        </div>
      </div>
    );
  }
          ...
          <div className="container mx-auto px-6 py-8">
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h1 className="text-3xl font-bold text-white">Keyword by Device</h1>
                  <p className="text-slate-300 mt-1">Check keyword results across devices.</p>
                </div>
              </div>
            ...
            >
              <Card className="bg-slate-800/50 backdrop-blur-sm border-slate-700/50 p-6">
                <h2 className="text-xl font-semibold text-white mb-4">Device-Based Keyword Performance</h2>
                <div className="text-slate-300">
                  <p className="mb-4">This page will check keyword results across devices.</p>
                  <p className="text-sm text-slate-400">Coming soon: Mobile vs desktop keyword performance, device-specific conversion rates, and cross-device keyword insights.</p>
                </div>
              </Card>
            </motion.div>
          </div>
