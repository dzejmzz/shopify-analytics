...
const sidebarItems = [
  ...
  { name: "Keyword by Plan", icon: Squares2X2Icon, href: "/search-term/plan-split", active: true },
...
export default function KeywordByPlan() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 flex items-center justify-center">
        <div className="flex items-center gap-3">
          ...
          <span className="text-slate-300 text-lg">Loading keyword by plan analysis...</span>
        </div>
      </div>
    );
  }
          ...
          <div className="container mx-auto px-6 py-8">
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h1 className="text-3xl font-bold text-white">Keyword by Plan</h1>
                  <p className="text-slate-300 mt-1">Match search terms to subscription plans.</p>
                </div>
              </div>
            ...
            >
              <Card className="bg-slate-800/50 backdrop-blur-sm border-slate-700/50 p-6">
                <h2 className="text-xl font-semibold text-white mb-4">Plan-Based Keyword Performance</h2>
                <div className="text-slate-300">
                  <p className="mb-4">This page will match search terms to subscription plans.</p>
                  <p className="text-sm text-slate-400">Coming soon: Plan-specific keyword performance, subscription conversion analysis, and pricing tier insights.</p>
                </div>
              </Card>
            </motion.div>
          </div>
