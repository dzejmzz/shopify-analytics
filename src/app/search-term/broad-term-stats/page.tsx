...
const sidebarItems = [
  ...
  { name: "Broad Match Performance", icon: MagnifyingGlassIcon, href: "/search-term/broad-term-stats", active: true },
];

export default function BroadMatchPerformance() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 flex items-center justify-center">
        <div className="flex items-center gap-3">
          ...
          <span className="text-slate-300 text-lg">Loading broad match performance...</span>
        </div>
      </div>
    );
  }
          ...
          <div className="container mx-auto px-6 py-8">
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h1 className="text-3xl font-bold text-white">Broad Match Performance</h1>
                  <p className="text-slate-300 mt-1">Deep dive into broad match terms.</p>
                </div>
              </div>
            ...
            >
              <Card className="bg-slate-800/50 backdrop-blur-sm border-slate-700/50 p-6">
                <h2 className="text-xl font-semibold text-white mb-4">Broad Match Term Analysis</h2>
                <div className="text-slate-300">
                  <p className="mb-4">This page will provide a deep dive into broad match terms.</p>
                  <p className="text-sm text-slate-400">Coming soon: Broad match keyword performance, search term expansion analysis, and broad match optimization insights.</p>
                </div>
              </Card>
            </motion.div>
          </div>
